...
case object Downville extends Topology {
  ...
  val viewpoints = Seq[CameraViewpoint](
    CameraViewpoint("entry1",
      new Vector3f(-SegmentLength * 11 / 2 - 10 - SegmentLength * 12, 3f, 0),
      new Quaternion().fromAngleAxis(RightAngle, Vector3f.UNIT_Y)),
    CameraViewpoint("entry2",
      new Vector3f(-SegmentLength * 11 / 2 + 10 - SegmentLength * 12, 3f, 0),
      new Quaternion().fromAngleAxis(-RightAngle, Vector3f.UNIT_Y)),
    CameraViewpoint("east-dev",
      new Vector3f(-SegmentLength * 11 / 2 + 10, 3f, TrackGap / 2),
      new Quaternion().fromAngleAxis(-RightAngle, Vector3f.UNIT_Y)),
    CameraViewpoint("east-platforms",
      new Vector3f(-SegmentLength * 11 / 2 - 10, 3f, TrackGap / 2),
      new Quaternion().fromAngleAxis(RightAngle, Vector3f.UNIT_Y)),
    CameraViewpoint("west-platforms",
      new Vector3f(SegmentLength * 11 / 2 + 10f, 3f, TrackGap / 2),
      new Quaternion().fromAngleAxis(-RightAngle, Vector3f.UNIT_Y)),
    CameraViewpoint("west-dev",
      new Vector3f(SegmentLength * 11 / 2 - 10f, 3f, TrackGap / 2),
      new Quaternion().fromAngleAxis(RightAngle, Vector3f.UNIT_Y)),
    CameraViewpoint("exit2",
      new Vector3f(SegmentLength * 11 / 2 + SegmentLength * 12 - 10f, 3f, 0f),
      new Quaternion().fromAngleAxis(RightAngle, Vector3f.UNIT_Y)),
